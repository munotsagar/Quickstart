...
//End Address */
	...
	private function validate() {
		...
		if ((utf8_strlen($this->request->post['telephone']) < 10) || (utf8_strlen($this->request->post['telephone']) > 10)|| preg_match('/[^\d]/is', $this->request->post['telephone'])) {
...
//Address - start
	/*    if ((utf8_strlen($this->request->post['street']) < 3) || (utf8_strlen($this->request->post['street']) > 32)) {
		...
		if ((utf8_strlen($this->request->post['zipcode']) < 3) || (utf8_strlen($this->request->post['zipcode']) > 32)) {
