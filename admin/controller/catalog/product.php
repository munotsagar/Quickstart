...
if (isset($this->request->get['filter_balance'])) {
			$filter_quantity = $this->request->get['filter_balance'];
		} else {
			$filter_quantity = '';
		}
		...
		$data['sort_balance'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.balance' . $url, true);
...
if (isset($this->request->get['filter_balance'])) {
		...
		if (isset($this->request->post['balance'])) {
			...
			$data['balance'] = $product_info['balance'];
		} else {
			$data['balance'] = '';
		}
			...
			if (isset($product_option['product_option_value'])) {
				foreach ($product_option['product_option_value'] as $product_option_value) {
					$product_option_value_data[] = array(
						...
						'balance'                => $product_option_value['balance'],
		...
		foreach ($product_discounts as $product_discount) {
			$data['product_discounts'][] = array(
				...
				'balance'          => $product_discount['balance'],
